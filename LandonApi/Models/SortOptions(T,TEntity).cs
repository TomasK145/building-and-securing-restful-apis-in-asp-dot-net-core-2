...
namespace LandonApi.Models
{
    ...
    {
        public string[] OrderBy { get; set; } //pri request je OrderBy parameter z  query stringu mapovany do tejto property
        ...
        //The service code will call this to apply sort options to a database query
